...
public class ShitCheckBox extends AppCompatCheckBox {
    ...
    private void onInitTypeface(Context context, AttributeSet attrs, int defStyle) {
        ...
        int typefaceValue = 0;
        if (attrs != null) {
            TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.ShitCheckBox, defStyle, 0);
            typefaceValue = values.getInt(R.styleable.ShitCheckBox_fonts, 0);
            values.recycle();
        }
