...
public class DataBerhasil {
    ...
    public DataBerhasil(String id, String fakturno, String cust_no, String cust_name, String hasildesc, String hasilkunjung
            , String jampickup, String jammulai, String jamselesai) {
        this.id = id;
