...
public class dialog_multiple_faktur extends AlertDialog {
    ...
    private void init() {
        ...
        txt_multipe_id = view.findViewById(R.id.txt_id_multiple);
        ...
        bt_ok.setOnClickListener(v -> {
            if (AYHelper.isEmpty(tx_dialog_desc)) {
                ...
                customer_faktur.selesai_update_multiple.put("kode_alasan", kode_alasan);
                customer_faktur.selesai_update_multiple.put("desc_alasan", desc_alasan);
                customer_faktur.selesai_update_multiple.put("tipe", tipe_alasan);
