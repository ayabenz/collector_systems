...
public class dialog_input_faktur extends AlertDialog {
    ...
    private void init() {
        ...
        sp_alasan = view.findViewById(R.id.sp_alasan);
        tx_dialog_title = view.findViewById(R.id.tx_dialog_title);
        tx_dialog_invoice_no = view.findViewById(R.id.tx_dialog_invoice_no);
        tx_dialog_id = view.findViewById(R.id.tx_dialog_id);
        tx_dialog_jml_bayar = view.findViewById(R.id.tx_dialog_jumlah_bayar);
        tx_dialog_desc = view.findViewById(R.id.tx_dialog_desc);
        ...
        bt_ok.setOnClickListener(v -> {
            if (kode_alasan.equalsIgnoreCase("8") && AYHelper.isEmpty(tx_dialog_jml_bayar)) {
                ...
                customer_faktur.selesai.put("kode_alasan", kode_alasan);
                customer_faktur.selesai.put("desc_alasan", desc_alasan);
                customer_faktur.selesai.put("tipe", tipe_alasan);
