    ...
    private void init() {
        ...
        bt_ok.setOnClickListener(v -> {
            if (AYHelper.isEmpty(tx_dialog_desc)) {
                ...
                customer_faktur.selesai_updateall.put("kode_alasan", kode_alasan);
                customer_faktur.selesai_updateall.put("desc_alasan", desc_alasan);
                customer_faktur.selesai_updateall.put("tipe", tipe_alasan);
