...
public class ShitButton extends AppCompatButton {
	 ...
	 */
	public ShitButton(Context context) {
		super(context);
	 ...
	 * @see #ShitButton(Context, AttributeSet, int)
	 */
	public ShitButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @see #ShitButton(Context, AttributeSet)
	 */
	public ShitButton(Context context, AttributeSet attrs, int defStyle) {
	...
	private void onInitTypeface(Context context, AttributeSet attrs, int defStyle) {
		...
		int typefaceValue = 0;
		if (attrs != null) {
			TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.ShitButton, defStyle, 0);
			typefaceValue = values.getInt(R.styleable.ShitButton_fonts, 0);
			values.recycle();
		}
