...
public class gagal extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        lvData = (ListView)view.findViewById(R.id.list_gagal);
    ...
    */
    ...
    private class CustomAdapter extends BaseAdapter {
        private Context c;
        private ArrayList<DataGagal> datas;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView txt_id = (TextView) v.findViewById(R.id.txt_g_id);
            TextView txt_inv = (TextView) v.findViewById(R.id.txt_g_invoice_no);
            TextView txt_mulai = (TextView) v.findViewById(R.id.txt_g_mulai);
            TextView txt_selesai = (TextView) v.findViewById(R.id.txt_g_complete);
            TextView txt_hasil = (TextView) v.findViewById(R.id.txt_g_hasil);
