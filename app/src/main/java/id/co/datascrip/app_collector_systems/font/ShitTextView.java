 ...
 */
public class ShitTextView extends AppCompatTextView {
	 ...
	 */
	public ShitTextView(Context context) {
		super(context);
	 ...
	 * @see #ShitTextView(Context, AttributeSet, int)
	 */
	public ShitTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @see #ShitTextView(Context, AttributeSet)
	 */
	public ShitTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void onInitTypeface(Context context, AttributeSet attrs, int defStyle) {
		...
		int typefaceValue = 0;
		if (attrs != null) {
			TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.ShitTextView, defStyle, 0);
			typefaceValue = values.getInt(R.styleable.ShitTextView_fonts, 0);
			values.recycle();
		}
