...
public class berhasil extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        lvData = view.findViewById(R.id.list_berhasil);
    ...
    private class CustomAdapter extends BaseAdapter {
        ...
        private final ArrayList<DataBerhasil> datas;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView txt_id = v.findViewById(R.id.txt_b_id);
            TextView txt_inv = v.findViewById(R.id.txt_b_invoice_no);
            TextView txt_mulai = v.findViewById(R.id.txt_b_mulai);
            TextView txt_selesai = v.findViewById(R.id.txt_b_complete);
            TextView txt_hasil = v.findViewById(R.id.txt_b_hasil);
